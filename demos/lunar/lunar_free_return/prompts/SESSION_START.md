...
```
I'm working on "Lunar Free Return" — a SMAIRT project (Scientific Method with AI Research Template).
...
```
Continuing "Lunar Free Return" — a SMAIRT project.
...
```
SMAIRT project "Lunar Free Return".
...
```
I need to plan a new experimental track for "Lunar Free Return".
...
The research question is: Can we find a TLI burn that yeilds a free-return?
...
```
I need to bring you fully up to speed on "Lunar Free Return".
