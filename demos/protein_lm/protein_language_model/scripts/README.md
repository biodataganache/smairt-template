...
1. Presents a menu of common benchmark datasets:
   ...
   - [Add others appropriate to my domain: computational_biology]
...
1. Generates synthetic data appropriate for testing Can a tiny masked language model recover a planted conserved motif from synthetic protein-like sequences?
