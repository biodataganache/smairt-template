...
```
I'm working on "Protein Properties" — a SMAIRT project (Scientific Method with AI Research Template).
...
Research Question: Can a hydrophobicity rule separate membrane from soluble proteins?
...
```
Continuing "Protein Properties" — a SMAIRT project.
...
```
I need to plan a new experimental track for "Protein Properties".
...
The research question is: Can a hydrophobicity rule separate membrane from soluble proteins?
...
```
I need to bring you fully up to speed on "Protein Properties".
