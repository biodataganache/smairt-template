...
| Selected reference | External claim or comparison | This project's result | Assessment |
|---|---|---|---|
| `references/sources/author_year_short_title/reference.md` | [Claim with source location] | [Observed result] | CONSISTENT / CONTRADICTS / NOT COMPARABLE |

Distinguish external literature claims from findings generated by this project.
Do not cite an unreviewed search result or discovery snippet as evidence.
