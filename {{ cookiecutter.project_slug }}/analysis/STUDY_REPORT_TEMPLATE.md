...
2. Read the research audit trail: `background/`, relevant reviewed records in `references/sources/`, `hypotheses/`, `experiments/`, `results/logs/`, `results/figures/`, `analysis/`, and `prompts/intellectual_contribution.md`.
...
| Reference ID | Key claim used | Verified source location | Used by |
|---|---|---|---|
| `references/sources/author_year_short_title/reference.md` | [Claim] | [Page, section, figure, table, or data field] | [Hypothesis, analysis, or paper section] |

Include only researcher-approved source records. Keep external claims distinct
from findings generated by this project.
