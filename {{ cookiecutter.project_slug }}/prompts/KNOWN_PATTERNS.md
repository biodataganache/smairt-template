...
### 2.2 [Example: Lenient parsing of input files]

**What happened**: [e.g., Used >= 2 columns instead of == 2, allowing malformed rows]

**Impact**: [e.g., Silently included garbage data in analysis]
